...
```bash
python analysis/make_figures.py     # writes figures/*.svg
```
...
analysis/                 every number in this repository, from fixed seeds
  ...
  check_site.py             validates the docs/ site before publishing
...
docs/                     the GitHub Pages site
  ...
  assets/figures/*.svg      publication figures, generated by make_figures.py
```
